...
------------------------------------------
function beamNPCeffect()
	local beameffect = config.getParameter("beamEffect")

	if beameffect == true then status.addEphemeralEffect("beamin", 1)
	elseif beameffect == false or beameffect == null then status.removeEphemeralEffect("beamin", 1)
	else status.removeEphemeralEffect("beamin", 1)
	end
end
------------------------------------------
